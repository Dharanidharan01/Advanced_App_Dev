...
function Sidebar() {
  return (
    <div className="flex flex-col w-64">
      <div className="flex items-center justify-center h-16 bg-gradient-to-r from-[#000428] to-[#004e92] text-white">
  {/* Logo */}
  <a href="/">
    <img src="logo.png" alt="Logo" className="h-8" />
  </a>
</div>
      <div className="flex flex-col flex-grow p-4 overflow-y-auto bg-gradient-to-r from-[#000428] to-[#004e92]">
        {/* Sidebar links */}
        <Link to="/overview" className="flex items-center mt-4 text-white hover:text-[#16dbff]">
          <img src="https://www.svgrepo.com/show/459911/dashboard.svg" alt="Overview Icon" className="w-5 h-5 mr-2" />
          Overview
        </Link>
        <Link to="/application-status" className="flex items-center mt-4 text-white hover:text-[#16dbff]">
          <img src="https://www.svgrepo.com/show/498451/status.svg" alt="Application Status Icon" className="w-5 h-5 mr-2" />
          Application Status
        </Link>
        <Link to="/pending-actions" className="flex items-center mt-4 text-white hover:text-[#16dbff]">
          <img src="https://www.svgrepo.com/show/309975/shifts-pending.svg" alt="Pending Actions Icon" className="w-5 h-5 mr-2" />
          Pending Actions
        </Link>
        <Link to="/career-guidance" className="flex items-center mt-4 text-white hover:text-[#16dbff]">
          <img src="https://www.svgrepo.com/show/418824/guide-location-map.svg" alt="Career Guidance Icon" className="w-5 h-5 mr-2" />
          Career Guidance
        </Link>
        <Link to="/certifications" className="flex items-center mt-4 text-white hover:text-[#16dbff]">
        ...
        <div className="mt-auto"> {/* Pushes "Settings" and "Logout" to bottom */}
          <Link to="/settings" className="flex items-center mt-4 text-white hover:text-[#16dbff]">
