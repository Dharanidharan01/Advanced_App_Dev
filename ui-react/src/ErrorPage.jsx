...
const Error404Page = () => {
  return (
    <div style={{ backgroundColor: '#e9fe6f', minHeight: '100vh', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
      {/* Load page */}
        ...
        <div className="container">
          ...
          <div id="light" className="row text-center">
            ...
            <div className="info">
              ...
              {/* end Rabbit */}
              <p style={{ color: 'black' }}>The page you are looking for was moved, removed,<br />
